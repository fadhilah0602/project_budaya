...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['id']) && isset($_POST['nama']) && isset($_POST['tanggal_lahir']) && isset($_POST['asal']) && isset($_POST['jenis_kelamin']) && isset($_POST['deskripsi'])) {
        $id = $_POST['id'];
        $nama = $_POST['nama'];
        ...
        $sql = "UPDATE sejarawan SET nama='$nama', foto='$foto', tanggal_lahir='$tanggal_lahir', asal='$asal', jenis_kelamin='$jenis_kelamin', deskripsi='$deskripsi' WHERE id='$id'";
